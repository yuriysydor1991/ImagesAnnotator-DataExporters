#ifndef IMAGES_ANNOTATOR_DATA_EXPORTERS_PROJECT_LOGGER_SUBSYSTEM_DECLARATIONS_H
#define IMAGES_ANNOTATOR_DATA_EXPORTERS_PROJECT_LOGGER_SUBSYSTEM_DECLARATIONS_H
...
#endif  // IMAGES_ANNOTATOR_DATA_EXPORTERS_PROJECT_LOGGER_SUBSYSTEM_DECLARATIONS_H
