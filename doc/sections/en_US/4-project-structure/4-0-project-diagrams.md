...
- `ImagesAnnotatorDataExporters011` - everything installed from [src/lib/facade/public](/src/lib/facade/public): `LibraryFacade`, `ILib`, `LibraryContext` with its three layout descendants, `IExporter` and the consumer implemented `IImageCropperFacility`;
