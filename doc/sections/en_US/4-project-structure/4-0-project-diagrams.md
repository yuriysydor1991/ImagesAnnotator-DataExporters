...
- `ImagesAnnotatorDataExporters011` - everything installed from [src/lib/facade/public](/src/lib/facade/public): `LibraryFacade`, `ILib`, `LibraryContext`, `IExporter`, `ExportContext`, `ExportFormat` and the consumer implemented `IImageCropperFacility`;
