...
Проект потребує CMake версії `3.13` або новішої і компілятора з підтримкою C++ `17`, як описано у підсекції [Мінімально можливі версії](/doc/sections/uk_UA/4-project-structure/4-6-minimal-possible-versions.md).
